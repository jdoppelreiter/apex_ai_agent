...
,p_global_page_id=>0
,p_navigation_list_id=>wwv_flow_imp.id(1480167705975347)
,p_navigation_list_position=>'TOP'
,p_navigation_list_template_id=>2526754704087354841
,p_nav_list_template_options=>'#DEFAULT#:js-tabLike'
,p_javascript_file_urls=>wwv_flow_string.join(wwv_flow_t_varchar2(
'#APP_FILES#js/helper#MIN#.js',
'#APP_FILES#js/webComponents/c-ticker#MIN#.js'))
,p_nav_bar_type=>'LIST'
,p_nav_bar_list_id=>wwv_flow_imp.id(1481250797975374)
